...
function setFeishuDmPolicy(cfg: ForgeOrchestratorConfig, dmPolicy: DmPolicy): ForgeOrchestratorConfig {
  const allowFrom =
    dmPolicy === "open"
...
function setFeishuAllowFrom(cfg: ForgeOrchestratorConfig, allowFrom: string[]): ForgeOrchestratorConfig {
  return {
    ...cfg,
    channels: {
      ...cfg.channels,
...
function setFeishuGroupAllowFrom(cfg: ForgeOrchestratorConfig, groupAllowFrom: string[]): ForgeOrchestratorConfig {
  return {
    ...cfg,
    channels: {
      ...cfg.channels,
