import type { ForgeOrchestratorConfig, DmPolicy } from "forge-orchestrator/plugin-sdk";
import {
...
function setGoogleChatDmPolicy(cfg: ForgeOrchestratorConfig, policy: DmPolicy) {
  const allowFrom =
    policy === "open"
