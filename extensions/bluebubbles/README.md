...
This directory contains the **BlueBubbles external channel plugin** for ForgeOrchestrator.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `forge-orchestrator/plugin-sdk` helpers.
