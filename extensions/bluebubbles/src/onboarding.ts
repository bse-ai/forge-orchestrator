...
function setBlueBubblesDmPolicy(cfg: ForgeOrchestratorConfig, dmPolicy: DmPolicy): ForgeOrchestratorConfig {
  const allowFrom =
  ...
  configure: async ({ cfg, prompter, accountOverrides, shouldPromptAccountIds }) => {
    ...
    await prompter.note(
      [
        ...
        "2. Add your ForgeOrchestrator gateway URL + webhook path",
