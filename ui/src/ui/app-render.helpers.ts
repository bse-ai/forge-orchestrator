  ...
  return html`
    <div class="chat-controls">
      <label class="field chat-controls__session">
        <select
          ...
          @change=${(e: Event) => {
            ...
            state.chatMessage = "";
            state.chatStream = null;
            (state as unknown as ForgeOrchestratorApp).chatStreamStartedAt = null;
            state.chatRunId = null;
            (state as unknown as ForgeOrchestratorApp).resetToolStream();
            (state as unknown as ForgeOrchestratorApp).resetChatScroll();
            state.applySettings({
              ...state.settings,
              sessionKey: next,
      ...
      <button
        ...
        @click=${async () => {
          const app = state as unknown as ForgeOrchestratorApp;
