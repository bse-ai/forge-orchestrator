...
#
# Output:
# - dist/ForgeOrchestrator.app
# - dist/ForgeOrchestrator-<version>.zip
# - dist/ForgeOrchestrator-<version>.dmg
...
APP="$ROOT_DIR/dist/ForgeOrchestrator.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/ForgeOrchestrator-$VERSION.zip"
DMG="$ROOT_DIR/dist/ForgeOrchestrator-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/ForgeOrchestrator-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/ForgeOrchestrator-$VERSION.dSYM.zip"
