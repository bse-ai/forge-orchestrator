...
ZIP=${1:?"Usage: $0 ForgeOrchestrator-<ver>.zip"}
FEED_URL=${2:-"https://raw.githubusercontent.com/forge-orchestrator/forge-orchestrator/main/appcast.xml"}
...
DOWNLOAD_URL_PREFIX=${SPARKLE_DOWNLOAD_URL_PREFIX:-"https://github.com/forge-orchestrator/forge-orchestrator/releases/download/v${VERSION}/"}
