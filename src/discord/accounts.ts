...
function mergeDiscordAccountConfig(cfg: ForgeOrchestratorConfig, accountId: string): DiscordAccountConfig {
...
export function listEnabledDiscordAccounts(cfg: ForgeOrchestratorConfig): ResolvedDiscordAccount[] {
