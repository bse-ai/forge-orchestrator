    ...
    await stopOpenClawChrome(
      {
        proc,
        cdpPort: 12345,
      } as unknown as Parameters<typeof stopForgeOrchestratorChrome>[0],
      10,
    );
    expect(proc.kill).not.toHaveBeenCalled();
  });

  it("stopForgeOrchestratorChrome sends SIGTERM and returns once CDP is down", async () => {
