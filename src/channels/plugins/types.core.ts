...
export type ChannelAgentToolFactory = (params: { cfg?: ForgeOrchestratorConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: ForgeOrchestratorConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: ForgeOrchestratorConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: ForgeOrchestratorConfig }) => boolean;
  supportsCards?: (params: { cfg: ForgeOrchestratorConfig }) => boolean;
