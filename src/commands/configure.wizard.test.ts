...
vi.mock("../config/config.js", () => ({
  CONFIG_PATH: "~/.forge-orchestrator/forge-orchestrator.json",
...
vi.mock("./onboard-helpers.js", () => ({
  DEFAULT_WORKSPACE: "~/.forge-orchestrator/workspace",
  applyWizardMetadata: (cfg: ForgeOrchestratorConfig) => cfg,
