...
export function applyOpencodeZenProviderConfig(cfg: ForgeOrchestratorConfig): ForgeOrchestratorConfig {
...
export function applyOpencodeZenConfig(cfg: ForgeOrchestratorConfig): ForgeOrchestratorConfig {
