...
export function applyVercelAiGatewayProviderConfig(cfg: ForgeOrchestratorConfig): ForgeOrchestratorConfig {
...
export function applyVercelAiGatewayConfig(cfg: ForgeOrchestratorConfig): ForgeOrchestratorConfig {
