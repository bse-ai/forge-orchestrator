...
function pickMaxBytes(cfg?: ForgeOrchestratorConfig, maxBytesMb?: number): number | undefined {
...
async function runImagePrompt(params: {
  ...
  await ensureForgeOrchestratorModelsJson(effectiveCfg, params.agentDir);
