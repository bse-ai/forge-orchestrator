...
describe("buildAgentSystemPrompt", () => {
  ...
  it("omits extended sections in minimal prompt mode", () => {
    const prompt = buildAgentSystemPrompt({
      workspaceDir: "/tmp/forge-orchestrator",
      promptMode: "minimal",
      ownerNumbers: ["+123"],
      skillsPrompt:
        "<available_skills>\n  <skill>\n    <name>demo</name>\n  </skill>\n</available_skills>",
      ...
      docsPath: "/tmp/forge-orchestrator/docs",
  ...
  it("includes a CLI quick reference section", () => {
    ...
    expect(prompt).toContain("## ForgeOrchestrator CLI Quick Reference");
    expect(prompt).toContain("forge-orchestrator gateway restart");
  ...
  it("preserves tool casing in the prompt", () => {
    ...
    expect(prompt).toContain("ForgeOrchestrator docs: /tmp/forge-orchestrator/docs");
    expect(prompt).toContain(
  ...
  // See: https://github.com/forge-orchestrator/forge-orchestrator/commit/66eec295b894bce8333886cfbca3b960c57c4946
  // Agents should use session_status or message timestamps to determine the date/time.
  // Related: https://github.com/forge-orchestrator/forge-orchestrator/issues/1897
  //          https://github.com/forge-orchestrator/forge-orchestrator/issues/3658
  it("does NOT include a date or time in the system prompt (cache stability)", () => {
    ...
    // https://github.com/forge-orchestrator/forge-orchestrator/issues/3658 for the preferred approach:
  ...
  it("adds ClaudeBot self-update guidance when gateway tool is available", () => {
    ...
    expect(prompt).toContain("## ForgeOrchestrator Self-Update");
