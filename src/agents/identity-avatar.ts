...
function resolveAvatarSource(cfg: ForgeOrchestratorConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: ForgeOrchestratorConfig, agentId: string): AgentAvatarResolution {
