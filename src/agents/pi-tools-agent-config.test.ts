...
*** End Patch`;
  ...
  it("should allow apply_patch when exec is allow-listed and applyPatch is enabled", () => {
    ...
    const tools = createForgeOrchestratorCodingTools({
      config: cfg,
      sessionKey: "agent:main:main",
      workspaceDir: "/tmp/test",
      agentDir: "/tmp/agent",
  ...
  it("should allow different tool policies for different agents", () => {
    ...
    const mainTools = createForgeOrchestratorCodingTools({
      config: cfg,
      sessionKey: "agent:main:main",
    ...
    const familyTools = createForgeOrchestratorCodingTools({
      config: cfg,
  ...
  it("should apply group tool policy overrides (group-specific beats wildcard)", () => {
    ...
    const trustedTools = createForgeOrchestratorCodingTools({
      config: cfg,
    ...
    const defaultTools = createForgeOrchestratorCodingTools({
      config: cfg,
  ...
  it("should apply per-sender tool policies for group tools", () => {
    ...
    const aliceTools = createForgeOrchestratorCodingTools({
      config: cfg,
    ...
    const bobTools = createForgeOrchestratorCodingTools({
      config: cfg,
      sessionKey: "agent:main:whatsapp:group:family",
      senderId: "bob",
  ...
  it("should not let default sender policy override group tools", () => {
    ...
    const adminTools = createForgeOrchestratorCodingTools({
      config: cfg,
