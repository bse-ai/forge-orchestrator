...
function resolveWatchPaths(workspaceDir: string, config?: ForgeOrchestratorConfig): string[] {
  const paths: string[] = [];
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: ForgeOrchestratorConfig }) {
