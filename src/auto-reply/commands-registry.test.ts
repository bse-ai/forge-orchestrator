...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@forge-orchestrator", { botUsername: "forge-orchestrator" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@forge-orchestrator args", {
        botUsername: "forge-orchestrator",
      }),
    ).toBe("/help args");
    expect(
      normalizeCommandBody("/help@forge-orchestrator: args", {
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "forge-orchestrator" })).toBe(
      "/help@otherbot",
    );
  });
