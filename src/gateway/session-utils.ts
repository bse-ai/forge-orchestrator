...
import { type ForgeOrchestratorConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: ForgeOrchestratorConfig): string[] {
...
export function listAgentsForGateway(cfg: ForgeOrchestratorConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: ForgeOrchestratorConfig): string {
...
function resolveSessionStoreAgentId(cfg: ForgeOrchestratorConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: ForgeOrchestratorConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
...
export function getSessionDefaults(cfg: ForgeOrchestratorConfig): GatewaySessionsDefaults {
