...
All skills-related configuration lives under `skills` in `~/.forge-orchestrator/forge-orchestrator.json`.
...
- Keys under `entries` map to the skill name by default. If a skill defines
  `metadata.forge-orchestrator.skillKey`, use that key instead.
