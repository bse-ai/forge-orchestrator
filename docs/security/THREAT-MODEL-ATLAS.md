# ForgeOrchestrator Threat Model v1.0
...
This threat model documents adversarial threats to the ForgeOrchestrator AI agent platform and ClawHub skill marketplace, using the MITRE ATLAS framework designed specifically for AI/ML systems.

### 1.2 Scope

| Component              | Included | Notes                                            |
| ---------------------- | -------- | ------------------------------------------------ |
| ForgeOrchestrator Agent Runtime | Yes      | Core agent execution, tool calls, sessions       |
...
| **Description**         | Attacker scans for exposed ForgeOrchestrator gateway endpoints                |
...
| **Affected Components** | ~/.forge-orchestrator/credentials/, config storage                    |
...
| ATLAS ID      | Technique Name                 | ForgeOrchestrator Threats                                                 |
| ------------- | ------------------------------ | ---------------------------------------------------------------- |
...
| **ClawHub**          | ForgeOrchestrator's skill marketplace                              |
| **Gateway**          | ForgeOrchestrator's message routing and authentication layer       |
| **MCP**              | Model Context Protocol - tool provider interface          |
| **Prompt Injection** | Attack where malicious instructions are embedded in input |
| **Skill**            | Downloadable extension for ForgeOrchestrator agents                |
| **SSRF**             | Server-Side Request Forgery                               |

---

_This threat model is a living document. Report security issues to security@forge-orchestrator.ai_
