...
This page tracks ForgeOrchestrator’s **formal security models** (TLA+/TLC today; more as needed).

> Note: some older links may refer to the previous project name.

**Goal (north star):** provide a machine-checked argument that ForgeOrchestrator enforces its
...
**What this is not (yet):** a proof that “ForgeOrchestrator is secure in all respects” or that the full TypeScript implementation is correct.

## Where the models live

Models are maintained in a separate repo: [vignesh07/forge-orchestrator-formal-models](https://github.com/vignesh07/forge-orchestrator-formal-models).
...
```bash
git clone https://github.com/vignesh07/forge-orchestrator-formal-models
cd forge-orchestrator-formal-models
