---
summary: "First-run onboarding flow for ForgeOrchestrator (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give ForgeOrchestrator">
...
<Step title="CLI">
  ...
  The app can install the global `forge-orchestrator` CLI via npm/pnpm so terminal
