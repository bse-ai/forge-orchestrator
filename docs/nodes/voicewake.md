...
ForgeOrchestrator treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.forge-orchestrator/settings/voicewake.json`

Shape:

```json
{ "triggers": ["forge-orchestrator", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
