...
read_when:
  - You are building a ForgeOrchestrator plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (forge-orchestrator.plugin.json)

Every plugin **must** ship a `forge-orchestrator.plugin.json` file in the **plugin root**.
ForgeOrchestrator uses this manifest to validate configuration **without executing plugin
