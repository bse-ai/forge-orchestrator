...
ForgeOrchestrator ships three update channels:
...
When you **explicitly** switch channels with `--channel`, ForgeOrchestrator also aligns
the install method:
...
When you switch channels with `forge-orchestrator update`, ForgeOrchestrator also syncs plugin sources:
