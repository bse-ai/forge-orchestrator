---
summary: "Use OpenAI via API keys or Codex subscription in ForgeOrchestrator"
read_when:
  - You want to use OpenAI models in ForgeOrchestrator
...
```bash
forge-orchestrator onboard --auth-choice openai-api-key
# or non-interactive
forge-orchestrator onboard --openai-api-key "$OPENAI_API_KEY"
```
...
forge-orchestrator onboard --auth-choice openai-codex
