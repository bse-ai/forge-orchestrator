...
### With ForgeOrchestrator

You can point ForgeOrchestrator at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or ForgeOrchestrator
...
- [Anthropic provider](/providers/anthropic) - Native ForgeOrchestrator integration with Claude setup-token or API keys
