...
- Install via CLI: `forge-orchestrator plugins install @forge-orchestrator/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `forge-orchestrator plugins install ./extensions/zalo`
   - From npm (if published): `forge-orchestrator plugins install @forge-orchestrator/zalo`
...
- Approve via:
  - `forge-orchestrator pairing list zalo`
  - `forge-orchestrator pairing approve zalo <CODE>`
...
- Example: `forge-orchestrator message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `forge-orchestrator channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `forge-orchestrator logs --follow`
