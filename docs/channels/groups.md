...
ForgeOrchestrator “lives” on your own messaging accounts. There is no separate WhatsApp bot user.
If **you** are in a group, ForgeOrchestrator can see that group and respond there.
...
Translation: allowlisted senders can trigger ForgeOrchestrator by mentioning it.
    ...
    list: [
      {
        id: "main",
        groupChat: {
          mentionPatterns: ["@forge-orchestrator", "forge-orchestrator", "\\+15555550123"],
          historyLimit: 50,
        },
      },
    ],
