...
```
  ...
  <Tab title="HTTP Events API mode">
    <Steps>
      ...
      <Step title="Configure ForgeOrchestrator HTTP mode">
...
```json
{
  "display_information": {
    ...
    "description": "Slack connector for ForgeOrchestrator"
  },
  "features": {
    "bot_user": {
      "display_name": "ForgeOrchestrator",
      "always_online": false
    },
    "app_home": {
...
```bash
forge-orchestrator pairing list slack
```
