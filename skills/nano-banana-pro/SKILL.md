...
- Or set `skills."nano-banana-pro".apiKey` / `skills."nano-banana-pro".env.GEMINI_API_KEY` in `~/.forge-orchestrator/forge-orchestrator.json`
...
- The script prints a `MEDIA:` line for ForgeOrchestrator to auto-attach on supported chat providers.
