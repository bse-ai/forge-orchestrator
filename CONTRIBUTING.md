# Contributing to ForgeOrchestrator
...
- **X/Twitter:** [@steipete](https://x.com/steipete) / [@forge-orchestrator](https://x.com/forge-orchestrator)
...
- Test locally with your ForgeOrchestrator instance
...
- **Skills**: For skill contributions, head to [ClawHub](https://clawhub.ai/) — the community hub for ForgeOrchestrator skills.
- **Performance**: Optimizing token usage and compaction logic.

Check the [GitHub Issues](https://github.com/forge-orchestrator/forge-orchestrator/issues) for "good first issue" labels!
